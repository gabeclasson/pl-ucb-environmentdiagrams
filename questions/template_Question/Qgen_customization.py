...
allowed_names = {
    # below are our variable names in the original codestring, 
    # and possible alternative names that can replace them
    "myVariable1": ["myVariable1", "alternateVariableName", "otherPossibleVariableName", "iLikeThisNameBest", "x"],
    "otherVariable": ["otherVariable", "theOther", "myVariableName2", "solidarnost"],
    "myInteger": ["myInteger", "bestInteger", "integer1", "num"],
    "veryFirstFunction": ["veryFirstFunction", "func1", "f"],
    "bestIndex": ["bestIndex", "i", "j", "k"]
    }
...
code_string = """ 
myVariable1 # line 0
otherVariable # line 1
myInteger # line 2
def veryFirstFunction(otherVariable):  # line 3
    for i in range(myInteger):  # line 4
        otherVariable.append(myVariable1)  # line 5
    return myInteger + len(otherVariable)  # line 6
