...
class FrameTree():
    ...
    def get_evaldiag(self, original_codestring):
        ...
        code_list = original_codestring.split("\n")
        ...
        try:
            ...
            raise Exception("Error evaluating the autogenerated code. Please contact an administrator. This question is ungradeable. Here is the question:\n"+ original_codestring)    
        ...
        self.fobj_framenode_dict = {}
        # for defined functions, keeps track of their parents frame.
        self.codestrID_parent_dict = {}
        self.framecounter = 0
